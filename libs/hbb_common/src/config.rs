...
pub const RENDEZVOUS_SERVERS: &[&str] = &["192.168.1.122"];
pub const RS_PUB_KEY: &str = "sLf2HSkPrOqNzR+LJoVatCLSIwGIxWAgVbhs9LmWjfY=";
...
pub mod keys {
    ...
    pub const OPTION_DIRECT_SERVER: &str = "true";
    ...
    pub const OPTION_API_SERVER: &str = "http://192.168.1.122:21114";
    pub const OPTION_KEY: &str = "sLf2HSkPrOqNzR+LJoVatCLSIwGIxWAgVbhs9LmWjfY=";
